...
: m_amb{r,g,b,1.0f}, m_dif{r,g,b,1.0f}, m_spe{1.0f,1.0f,1.0f,1.0f}, m_shi(90.0f)
{
}

MaterialPtr Material::Make (float r, float g, float b)
{
  return MaterialPtr (new Material(r,g,b));
} 
